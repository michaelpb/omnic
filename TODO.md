...
- [ ] Testing infrastructure
    ...
    - [ ] Create context manager that uses ForegroundWorker to churn though the
    ...
    - [ ] Write tests for ForegroundWorker
    - [ ] Clean up ALL warnings / noise generated by running tests
